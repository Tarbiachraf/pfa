...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<CustomErrorResponse> handleResourceAlreadyException(ResourceAlreadyExistException ex) {
        CustomErrorResponse customErrorResponse = new CustomErrorResponse(ex.getResourceType(),ex.getErrorMessage());
        return new ResponseEntity<>(customErrorResponse, HttpStatus.NOT_FOUND);
    }
}
